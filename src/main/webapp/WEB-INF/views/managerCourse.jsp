...
<div class="panel panel-primary">
    ...
    <form>
        <div>
            ...
            <button type="button" class="ui green tiny  button" id="btnSaveCourse">Add</button>
        </div>
    </form>
    <form>
        ...
        <div style="margin-bottom: 20px">
            ...
            <div class="ui tiny buttons" style="margin:20px">
                <div class="ui green button" id="btnEditCourse">Edit</div>
                <div class="or"></div>
                <div class="ui red button" id="btnRemoveCourse">Remove</div>
            </div>
        </div>
    </form>
    </div>
...
<div class="panel panel-primary">
    ...
    <form>
        <div >
            ...
            <button type="button" class="ui green tiny  button" id="btnSaveSubject">Add</button>
        </div>
    </form>
    ...
    <form>
        <div style="margin-bottom: 20px">
            ...
            <div class="ui tiny buttons" style="margin: 10px">
                <div class="ui green button" id="btnEditSubject">Edit</div>
                <div class="or"></div>
                <div class="ui red button" id="btnRemoveSubject">Remove</div>
            </div>
        </div>
    </form>
    </div>
...
<div class="panel panel-primary">
    ...
    <form>
        <div>
            ...
            <button type="button" class="ui green tiny  button" id="btnSaveTopic">Add</button>
        </div>
    </form>
    ...
    <form>
        <div style="margin-bottom: 20px">
            ...
            <div class="ui tiny buttons" style="margin: 10px">
                <div class="ui green button" id="btnEditTopic">Edit</div>
                <div class="or"></div>
                <div class="ui red button" id="btnRemoveTopic">Remove</div>
            </div>
        </div>
    </form>
    </div>
