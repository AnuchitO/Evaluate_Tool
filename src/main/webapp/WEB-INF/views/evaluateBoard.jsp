	...
	<div class="container">
		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-primary">
				<div class="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapseObject">
					<h4 class="panel-title" >Object - Oriented<span class="badge pull-right">4</span></h4>
				</div>
				<div id="collapseObject" class="panel-collapse collapse">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="#">Abstraction : Understand abstraction concept</a></li>
							<li><a href="#">Encapsulation : Understand encapsulation concept</a></li>
							<li><a href="#">Inheritance : Understand inheritance concept</a></li>
							<li><a href="#">Polymorphism : Understand polymorphism concept</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="panel panel-primary">
				<div class="panel-heading" data-toggle="collapse" data-parent="#accordion" href="#collapseJava">
					<h4 class="panel-title">Java<span class="badge pull-right">3</span></h4>
				</div>
				<div id="collapseJava" class="panel-collapse collapse">
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="#">Assignments : grade B Understand default value of variable, scope of variable wrapper class.</a></li>
							<li><a href="#">Declaration & Access control : grade C Can declare variable and class in java.</a></li>
							<li><a href="#">Flow Control - Exceptions : grade C Understand the mechanism of  condition statement such as If...else, switch and every type of loop.</a></li>
						</ul>
					</div>
				</div>
			</div>
